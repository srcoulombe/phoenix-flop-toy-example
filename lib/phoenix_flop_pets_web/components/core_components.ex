defmodule PhoenixFlopPetsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixFlopPetsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixFlopPetsWeb.Gettext, "errors", msg, opts)
    end
  end
